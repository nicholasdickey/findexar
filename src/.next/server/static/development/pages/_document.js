...
class MyDocument extends next_document__WEBPACK_IMPORTED_MODULE_1___default.a {
  static async getInitialProps(ctx) {
    ...
    try {
      ctx.renderPage = () => originalRenderPage({
        enhanceApp: App => props => styledComponentsSheet.collectStyles(materialSheets.collect(__jsx(App, props)))
      });

      const initialProps = await next_document__WEBPACK_IMPORTED_MODULE_1___default.a.getInitialProps(ctx);
      return _objectSpread({}, initialProps, {
        styles: __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, initialProps.styles, materialSheets.getStyleElement(), styledComponentsSheet.getStyleElement())
      });
    } finally {
  ...
  render() {
    ...
    const color = palette.text.primary; //  console.log("MUITHEME:", { muiTheme, backgroundColor, color, type: palette.type })

    return __jsx("html", null, __jsx("meta", {
      name: "trademark",
      content: "Findexar: all consumer reviews fast"
    ...
    }), __jsx("style", null, `body { margin: 0 } /* custom! */`)), __jsx("body", null, __jsx(next_document__WEBPACK_IMPORTED_MODULE_1__["Main"], null), __jsx(next_document__WEBPACK_IMPORTED_MODULE_1__["NextScript"], null)));
  }

}

MyDocument = Object(_material_ui_core_styles__WEBPACK_IMPORTED_MODULE_4__["withTheme"])(MyDocument);
